...
struct PlayStruct play_struct ={4,4.5, "Robin Fuchshofer"};
struct PlayStruct *play_struct_pointer = &play_struct;
char another_string[16] = "Neuer string";
char *another_string_p = another_string;

print_struct(play_struct, play_struct_pointer);
change_struct(play_struct, play_struct_pointer); //it takes the number of the pointer
print_struct(play_struct, play_struct_pointer);
